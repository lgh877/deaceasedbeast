...
import net.mcreator.deaceased.procedures.ThefaceEntityIsHurtProcedure;
import net.mcreator.deaceased.procedures.ThefaceEntityDiesProcedure;
import net.mcreator.deaceased.procedures.FacetickProcedure;
import net.mcreator.deaceased.procedures.CancelwalkProcedure;
import net.mcreator.deaceased.init.DeaceasedModEntities;
import net.mcreator.deaceased.StrafeDashGoal;
...
public class ThefaceEntity extends Monster implements GeoEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(5, new StrafeDashGoal(this, 10, // desired distance from target
				2, // dash speed
				8 // cooldown between dashes (ticks)
		));
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("deaceased:faceambt"));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("deaceased:facefly")), 0.15f, 1);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		ThefaceEntityIsHurtProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public void die(DamageSource source) {
		super.die(source);
		ThefaceEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public void baseTick() {
		super.baseTick();
		FacetickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.FOLLOW_RANGE, 87);
