...
public class ThefaceModel extends GeoModel<ThefaceEntity> {
	...
	@Override
	public void setCustomAnimations(ThefaceEntity animatable, long instanceId, AnimationState animationState) {
		CoreGeoBone head = getAnimationProcessor().getBone("pivot");
		if (head != null) {
